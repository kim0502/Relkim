...
INSERT INTO `student` VALUES ('b002','관우','심리학과','010-222','서울'),('b003','장비','경제학과','010-333','서울'),('c001','조조','국문학과','016-111','경기'),('c002','여포','심리학과','016-222','경기'),('c003','손견','경제학과','016-333','경기'),('d001','홍길동','수학과','017-001','광주'),('S001','박소명','컴퓨터공학과','123-4567',NULL),('S002','최민국','컴퓨터공학과','234-5678',NULL),('S003','이승호','국문학과','345-6789',NULL),('S004','정수봉','국문학과','456-7890',NULL),('S005','김상진','사학과','567-8901',NULL),('S006','황정숙','사학과','678-9012',NULL);
...
-- Dump completed on 2022-05-26 17:09:56
